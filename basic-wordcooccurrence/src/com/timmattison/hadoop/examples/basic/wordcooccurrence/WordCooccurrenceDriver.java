...
public class WordCooccurrenceDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		// Our mapper will output a Text key and an IntWritable value
		conf.setMapOutputKeyClass(Text.class);
		conf.setMapOutputValueClass(IntWritable.class);

		// Our reducer will output a Text key and an IntWritable value
	...
	public static void main(String[] args) throws Exception {
		// Run our WordCooccurrenceDriver class after ToolRunner processes its options
