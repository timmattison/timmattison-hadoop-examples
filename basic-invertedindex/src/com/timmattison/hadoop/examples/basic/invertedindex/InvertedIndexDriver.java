...
public class InvertedIndexDriver extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(getConf(), InvertedIndexDriver.class);

		// Set the job's name to the name of this driver class
		conf.setJobName(this.getClass().getName());

		// Set our mapper class as the InvertedIndexMapper class
		conf.setMapperClass(InvertedIndexMapper.class);

		// Set our reducer class as the InvertedIndexReducer class
		...
		// Our mapper will output a Text key and a Text value
		conf.setMapOutputKeyClass(Text.class);
		conf.setMapOutputValueClass(Text.class);

		// Our reducer will output a Text key and a Text value
	...
	public static void main(String[] args) throws Exception {
		// Run our InvertedIndexDriver class after ToolRunner processes its options
